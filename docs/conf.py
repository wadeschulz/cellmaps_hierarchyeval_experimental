...
# -*- coding: utf-8 -*-
#
# cellmaps_hierarchyeval documentation build configuration file, created by
...
project = u'cellmaps_hierarchyeval'
...
init_file = os.path.join('..', 'cellmaps_hierarchyeval', '__init__.py')
...
htmlhelp_basename = 'cellmaps_hierarchyevaldoc'
...
latex_documents = [
    (master_doc, 'cellmaps_hierarchyeval.tex',
     u'cellmaps_hierarchyeval Documentation',
     u'Clara Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'cellmaps_hierarchyeval',
     u'cellmaps_hierarchyeval Documentation',
     [author], 1)
]
